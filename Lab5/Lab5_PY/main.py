...
# question-1
def passGen(number):
    while number not in [3, 4, 5, 6, 7]:
        number = int(input("Enter a number[3-7]: "))

    selected_words = random.sample(words, number)
    password = ""
...
user_number = int(input("Enter a number[3-7]: "))
print(passGen(user_number))


#question-2
def rep_with_upper(string):
    replace = random.choice(string)
    new_string = string.replace(replace, replace.upper())
    return new_string
...
def swap_letters(string):
    if len(string) < 2:
        ...
        middle = string[2:-2]
        new_string = last_two_letters + middle + first_two_letters
        return new_string


initial_psswrd = passGen(user_number)
new_psswrd = rep_with_upper(initial_psswrd)
final_psswrd = swap_letters(new_psswrd)

print("Initial password: " + initial_psswrd)
print("New password: " + new_psswrd)
print("Final version of the password: " + final_psswrd)
...
key_letter = input("Enter first letter of your name: ")
a = search_letter(final_psswrd, key_letter)
if a:
    print("The key exists in the final password")
else:
    print("The key does not exist in the final password")
